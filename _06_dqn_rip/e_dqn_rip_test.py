...
from _06_dqn_rip.b_dqn_train_test import DQNTester
...
def main():
    ...
    model_path = "/home/hyoseok/src/koreatech_rl/_06_dqn_rip/models/dqn_quanser_3838.2_qnet_20250829_202957.pth"
    dqn = DQNTester(env=env, num_episodes=30, model_path=model_path)
    dqn.test()
